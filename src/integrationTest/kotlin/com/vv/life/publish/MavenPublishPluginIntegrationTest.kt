...
class MavenPublishPluginIntegrationTest(
  ...
  @Before fun setUp() {
    ...
    File("${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.FIXTURES}/common").listFiles()?.forEach { it.copyRecursively(testProjectDir.root.resolve(it.name)) }
  }
  ...
  @Test fun generatesArtifactsAndDocumentationOnJavaLibraryWithGroovyProject() {
    ...
    assertExpectedTasksRanSuccessfully(result)
    assertExpectedCommonArtifactsGenerated()
    assertArtifactGenerated(artifactFileNameWithExtension = "${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_POM_ARTIFACT_ID}-${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_VERSION_NAME}-groovydoc.jar")
    assertPomContentMatches()
  ...
  @Test fun generatesArtifactsAndDocumentationOnKotlinMppProject() {
    ...
    val metadataArtifactId = "${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_POM_ARTIFACT_ID}-metadata"
    assertExpectedCommonArtifactsGenerated("module", metadataArtifactId)
    assertArtifactGenerated("$metadataArtifactId-${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_VERSION_NAME}.jar", metadataArtifactId)
    assertPomContentMatches(metadataArtifactId)

    val jvmArtifactId = "${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_POM_ARTIFACT_ID}-jvm"
    assertExpectedCommonArtifactsGenerated("module", jvmArtifactId)
    assertArtifactGenerated("$jvmArtifactId-${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_VERSION_NAME}.jar", jvmArtifactId)
    assertPomContentMatches(jvmArtifactId)

    val nodejsArtifactId = "${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_POM_ARTIFACT_ID}-nodejs"
    assertExpectedCommonArtifactsGenerated("module", nodejsArtifactId)
    assertArtifactGenerated("$nodejsArtifactId-${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_VERSION_NAME}.jar", nodejsArtifactId)
    assertPomContentMatches(nodejsArtifactId)

    val linuxArtifactId = "${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_POM_ARTIFACT_ID}-linux"
    assertExpectedCommonArtifactsGenerated("module", linuxArtifactId)
    assertArtifactGenerated("$linuxArtifactId-${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_VERSION_NAME}.klib", linuxArtifactId)
  ...
  private fun setupFixture(fixtureName: String) {
    File("${_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.FIXTURES}/$fixtureName").copyRecursively(testProjectDir.root, overwrite = true)
  }
  ...
  private fun assertExpectedCommonArtifactsGenerated(
    ...
    artifactId: String = _root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_POM_ARTIFACT_ID,
    groupId: String = _root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_GROUP,
    version: String = _root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.TEST_VERSION_NAME
  ) {
  ...
  private fun assertPomContentMatches(
    ...
    val expectedContent = testProjectDir.root.resolve(_root_ide_package_.com.vv.life.publish.MavenPublishPluginIntegrationTest.Companion.EXPECTED_DIR).resolve(pomFileName).readText()
