...
import com.vv.life.publish.nexus.NexusConfigurer
...
open class MavenPublishPlugin : Plugin<Project> {
  ...
  override fun apply(p: Project) {
    ...
    if (gradleVersion < VersionNumber(MavenPublishPlugin.Companion.MINIMUM_GRADLE_MAJOR, MavenPublishPlugin.Companion.MINIMUM_GRADLE_MINOR, MavenPublishPlugin.Companion.MINIMUM_GRADLE_MICRO, null)) {
    ...
    val pom = MavenPublishPom.Companion.fromProject(p)
    p.group = pom.groupId
  ...
  private fun configureDokka(project: Project) {
    project.plugins.withId("org.jetbrains.kotlin.jvm") {
      project.plugins.apply(MavenPublishPlugin.Companion.PLUGIN_DOKKA)
    }
    ...
    project.plugins.withId(MavenPublishPlugin.Companion.PLUGIN_DOKKA) {
