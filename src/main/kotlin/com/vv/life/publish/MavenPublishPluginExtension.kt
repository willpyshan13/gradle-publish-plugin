...
import com.vv.life.publish.nexus.NexusOptions
...
open class MavenPublishPluginExtension(project: Project) {
  ...
  private val defaultTarget = MavenPublishTarget(
    DEFAULT_TARGET,
    project.findOptionalProperty("RELEASE_REPOSITORY_URL")
      ?: System.getenv("RELEASE_REPOSITORY_URL")
      ?: "https://oss.sonatype.org/service/local/staging/deploy/maven2/",
    project.findOptionalProperty("SNAPSHOT_REPOSITORY_URL")
      ?: System.getenv("SNAPSHOT_REPOSITORY_URL")
  ...
  private val localTarget = MavenPublishTarget(LOCAL_TARGET,
