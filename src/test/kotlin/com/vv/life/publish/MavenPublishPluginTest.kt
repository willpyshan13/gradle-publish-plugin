...
class MavenPublishPluginTest {
  ...
  private fun assert(project: Project) {
    project.plugins.apply(_root_ide_package_.com.vv.life.publish.MavenPublishPlugin::class.java)

    val extension = project.extensions.getByType(_root_ide_package_.com.vv.life.publish.MavenPublishPluginExtension::class.java)
